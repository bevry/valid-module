...
<span class="badge-daviddmdev"><a href="https://david-dm.org/bevry/valid-module#info=devDependencies" title="View the status of this project's development dependencies on DavidDM"><img src="https://img.shields.io/david/dev/bevry/valid-module.svg" alt="Dev Dependency Status" /></a></span>
...
``` typescript
import * as pkg from 'https://unpkg.com/valid-module@^1.10.0/edition-deno/node.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/valid-module/^1.10.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/valid-module@^1.10.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/valid-module@1.10.0'
</script>
```
