...
``` typescript
import * as pkg from 'https://unpkg.com/valid-module@^1.5.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import * as pkg from '//cdn.pika.dev/valid-module/^1.5.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//unpkg.com/valid-module@^1.5.0'
</script>
```
...
``` html
<script type="module">
    import * as pkg from '//dev.jspm.io/valid-module@1.5.0'
</script>
```
